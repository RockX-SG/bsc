...
var (
	MaxBlockFetch   = 16  // Amount of blocks to be fetched per retrieval request
	MaxHeaderFetch  = 32  // Amount of block headers to be fetched per retrieval request
	MaxSkeletonSize = 128 // Number of header fetches to need for a skeleton assembly
	MaxReceiptFetch = 64  // Amount of transaction receipts to allow fetching per request
	MaxStateFetch   = 64  // Amount of node state values to allow fetching per request
